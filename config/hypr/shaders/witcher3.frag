...
// corrigindo. O que falta é âmbar nas luzes e contraste: Velen tem de
// pesar, Toussaint tem de doer de tão dourado.
//
// Contraste alto (1.16) e vibrance forte (0.18) — aqui o excesso é o
// ponto, é o que separa o "The Witcher 3" do "The Witcher 3 com filtro".
...
void main() {
    ...
    c = pretos(c, 0.12);
    c = contraste(c, 1.16, 0.46);
    c = tonalizar(c, vec3(0.95, 0.98, 1.06), vec3(1.11, 1.03, 0.86), 0.60);
    c = vibrance(c, 0.18);
    c *= vinheta(v_texcoord, 0.18, 0.29);
